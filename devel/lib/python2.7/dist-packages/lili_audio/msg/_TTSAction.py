...
"""autogenerated by genpy from lili_audio/TTSAction.msg. Do not edit."""
import sys
...
class TTSAction(genpy.Message):
  _md5sum = "a1f047211d937fc6b6752e9d0875c622"
  _type = "lili_audio/TTSAction"
...
"""
  ...
  _slot_types = ['lili_audio/TTSActionGoal','lili_audio/TTSActionResult','lili_audio/TTSActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = lili_audio.msg.TTSActionGoal()
      if self.action_result is None:
        self.action_result = lili_audio.msg.TTSActionResult()
      if self.action_feedback is None:
        self.action_feedback = lili_audio.msg.TTSActionFeedback()
    else:
      self.action_goal = lili_audio.msg.TTSActionGoal()
      self.action_result = lili_audio.msg.TTSActionResult()
      self.action_feedback = lili_audio.msg.TTSActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.speech
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.voice
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.speech = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.speech = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_goal.goal.voice = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.voice = str[start:end]
      _x = self
      start = end
      end += 12
