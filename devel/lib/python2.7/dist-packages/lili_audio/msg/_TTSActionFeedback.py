...
"""autogenerated by genpy from lili_audio/TTSActionFeedback.msg. Do not edit."""
import sys
...
class TTSActionFeedback(genpy.Message):
  ...
  _type = "lili_audio/TTSActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lili_audio/TTSFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.feedback is None:
        self.feedback = lili_audio.msg.TTSFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = lili_audio.msg.TTSFeedback()
