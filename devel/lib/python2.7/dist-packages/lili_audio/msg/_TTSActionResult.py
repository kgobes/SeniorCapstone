...
"""autogenerated by genpy from lili_audio/TTSActionResult.msg. Do not edit."""
import sys
...
class TTSActionResult(genpy.Message):
  ...
  _type = "lili_audio/TTSActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','lili_audio/TTSResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = lili_audio.msg.TTSResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = lili_audio.msg.TTSResult()
